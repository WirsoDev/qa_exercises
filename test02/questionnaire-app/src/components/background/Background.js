    ...
    <div className="background">
      ...
      >
        <path
          ...
          fill="#EFC3C3"
        />
        <circle cx="78" cy="879" r="210" fill="#EAEAEA" />
        <circle cx="1003" cy="182" r="137" fill="#EAEAEA" />
        <circle cx="1281" cy="365" r="110" fill="#EFC3C3" />
        <circle cx="574" cy="176" r="48" fill="#EFC3C3" />
        <circle cx="855" cy="757" r="48" fill="#EFC3C3" />
        <path
